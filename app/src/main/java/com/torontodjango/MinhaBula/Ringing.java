...
public class Ringing extends Activity {
    ...
    private void addNotification(Task task)
    {
        ...
        Log.i(TAG, "adicionando notificação...");
        ...
        @SuppressLint({"NewApi", "LocalSuppress"}) NotificationChannel channel = new NotificationChannel("alarmme_01", "AlarmMe Notifications",
        ...
        Log.d(TAG, "notificação adicionada");
    }
