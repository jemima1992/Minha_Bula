...
class TaskListAdapter extends BaseAdapter{
    ...
    {
        Log.d(TAG, "chamando construtor, o contexto é " + (context!=null ? "not null" : "null"));
    ...
    private void setTask(Task task){
        ...
        Log.d(TAG, "Definir tarefa para alarme em " + task.getDate() + (task.getEnabled() ? " ativado" : "") + (task.getOutdated() ? " desatualizado" : ""));
...
public class DashBoardActivity extends AppCompatActivity implements TasksFragment.OnFragmentInteractionListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d(TAG, "iniciando atividade do painel");
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                {
                    case R.id.dashboard:
                        Log.d(TAG, "Escolhendo Horario");
                        break;
                    case R.id.help:
                        fragmentClass = HelpFragment.class;
                        Log.d(TAG, "Escolhendo ajuda");
