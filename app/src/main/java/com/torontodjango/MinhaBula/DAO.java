...
public class DAO {
    ...
    {
        Log.d(TAG, "Obtendo instância do DAO");
        if (dao == null)
        {
            dao = new DAO();
    ...
    private void load(){
        ...
        {
            Log.d(TAG, "Não é possível carregar tarefas");
        }
    }
    ...
    {
        Log.d(TAG, "Não é possível salvar ");
    }
    }
